// === 因果推断 · Interactive - Core Application ===
...
const App = {
    ...
    // --- Progress ---
    loadProgress() {
        try { this.progress = JSON.parse(localStorage.getItem('causal-inference-progress') || '{}'); }
        catch (e) { this.progress = {}; }
    },
    saveProgress() {
        try { localStorage.setItem('causal-inference-progress', JSON.stringify(this.progress)); } catch (e) {}
    },
